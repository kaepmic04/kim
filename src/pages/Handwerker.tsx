...
import { ArrowLeft, Wrench, Clock, TrendingUp, DollarSign, Calendar, Users } from 'lucide-react';
...
const benefits = [
  {
    icon: Clock,
    title: 'Zeitersparnis',
    description: 'Reduzieren Sie den Zeitaufwand für Telefonate und Terminplanung um bis zu 80%. Konzentrieren Sie sich auf Ihre Kernaufgaben, während die KI Anrufe entgegennimmt.'
  },
  {
    icon: TrendingUp,
    title: 'Umsatzsteigerung',
    description: 'Steigern Sie Ihren Umsatz durch verbesserte Erreichbarkeit. Kein verpasster Anruf bedeutet kein verpasster Auftrag - auch außerhalb der Geschäftszeiten.'
  },
  {
    icon: DollarSign,
    title: 'Kostenreduktion',
    description: 'Sparen Sie die Kosten für eine Vollzeit-Telefonkraft. Unsere KI-Lösung ist deutlich günstiger und arbeitet rund um die Uhr ohne Überstunden oder Urlaub.'
  },
  {
    icon: Calendar,
    title: 'Optimierte Terminplanung',
    description: 'Automatisierte Terminplanung und -erinnerungen reduzieren No-Shows um bis zu 70% und sorgen für eine optimale Auslastung Ihres Betriebs.'
  },
  {
    icon: Users,
    title: 'Verbesserte Kundenzufriedenheit',
    description: 'Bieten Sie Ihren Kunden einen erstklassigen Service durch sofortige Anrufannahme ohne Wartezeiten und professionelle Gesprächsführung.'
  }
];

export function Handwerker() {
  return (
        ...
        >
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center p-2 bg-blue-500/10 rounded-full mb-4">
              ...
              <span className="text-blue-400 font-medium">Branchenlösung für Handwerker</span>
            </div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Optimieren Sie Ihre Telefonkommunikation, sparen Sie Zeit und Kosten und steigern Sie Ihren Umsatz 
              mit einer maßgeschneiderten KI-Sprachassistenz für Ihren Handwerksbetrieb.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            >
              <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 border border-gray-800 h-full">
                <h2 className="text-2xl font-bold text-white mb-6">Die Herausforderungen für Handwerksbetriebe</h2>
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Während Sie auf der Baustelle sind oder einen Kunden bedienen, gehen wertvolle Anrufe verloren.</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0 w-8 h-8 bg-red-500/20 rounded-full flex items-center justify-center mt-1 mr-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Die manuelle Terminplanung und -verwaltung kostet wertvolle Zeit, die Sie für Ihr Kerngeschäft nutzen könnten.</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0 w-8 h-8 bg-red-500/20 rounded-full flex items-center justify-center mt-1 mr-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Eine Vollzeit-Telefonkraft ist für viele Handwerksbetriebe zu teuer, aber ohne sie gehen Aufträge verloren.</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0 w-8 h-8 bg-red-500/20 rounded-full flex items-center justify-center mt-1 mr-4">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Unsere KI nimmt Anrufe rund um die Uhr entgegen - auch am Wochenende, an Feiertagen und außerhalb der Geschäftszeiten.</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0 w-8 h-8 bg-green-500/20 rounded-full flex items-center justify-center mt-1 mr-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400">Unsere KI ist speziell für Handwerksbetriebe trainiert und versteht die spezifischen Anforderungen und Fachbegriffe.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                Unsere KI-Sprachassistenz bietet zahlreiche Vorteile, die Ihren Betrieb effizienter, 
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4">
              Bereit, Ihren Handwerksbetrieb zu optimieren?
            </h2>
            <p className="text-gray-300 mb-8 max-w-3xl mx-auto">
              Vereinbaren Sie ein unverbindliches Beratungsgespräch und erfahren Sie, wie unsere 
              KI-Sprachassistenz speziell für Ihren Handwerksbetrieb angepasst werden kann.
            </p>
            <Button
              size="lg"
